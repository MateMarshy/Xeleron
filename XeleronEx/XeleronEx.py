...
ascii_banner = pyfiglet.figlet_format("Xeleron v1")
print(ascii_banner)
print("discord.gg/xeleron")
print("remade by Marshy")
print("Originally made by rip and jayyy")

# Set these if you want
PlaceId = 15526393674   # Determines the PlaceId, if it is 0 then it'll ask for your input.
...
# Game Link: https://www.roblox.com/games/15610085219/jbaited
# Join the game and start the Python program!


input(
    "Make sure you are in this game and press enter anything to continue: https://www.roblox.com/games/15526393674/ddbeta"
)
